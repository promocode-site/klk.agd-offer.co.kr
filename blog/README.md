...
주소는 `https://klk.agd-offer.co.kr/blog/agoda-coupon/` 가 됩니다.
...
| `{{canonical}}` | 글의 정식 주소 | https://klk.agd-offer.co.kr/blog/agoda-coupon/ |
...
- 포인트 색: **#1A6FC4** (ocean) — `blog.css` 맨 위 `--blog-point`
